...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function OutputPoolInfo(){
        ...
        console.log("LMNode: %j", _this.jobManager.currentJob.rpcData.lmnode);
        var infoLines = [startMessage,
                ...
                'Current lmnode Payee:\t' + _this.jobManager.currentJob.rpcData.lmnode.height,
