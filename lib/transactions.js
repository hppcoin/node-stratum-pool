...
if (rpcData.lmnode.payee) {
         var lmnReward = 0;
 
         lmnReward = 2000000000;
         reward -= lmnReward;
         rewardToPool -= lmnReward;
 
         var lmnPayeeScript = util.addressToScript(rpcData.lmnode.payee);
         txOutputBuffers.push(Buffer.concat([
             util.packInt64LE(lmnReward),
             util.varIntBuffer(lmnPayeeScript.length),
             lmnPayeeScript
         ]));
}
...
var recipientReward = 100000000;
        if(rpcData.height>16360){
        if(i==6) recipientReward = 150000000;
        if(i==7) recipientReward = 50000000;
    }
